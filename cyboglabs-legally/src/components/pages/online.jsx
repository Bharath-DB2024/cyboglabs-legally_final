...
//   const initLeegality = (signingUrl) => {
...
//   const handleSubmit = async (e) => {
    ...
    //   initLeegality(response.data.url); // Use dynamic URL
...
//           <input name="contractDescription" placeholder="Contract Description" value={formData.contractDescription} onChange={handleChange} />
...
//             <input name="fromDate2" type="date" value={formData.fromDate2} onChange={handleChange} />
//           </div>
...
//       /> */}
//       <div className='cl'  onClick={closeModal}>  <p className="close-button">X</p></div>
     
//       <NDAStyledLayout ref={ndaRef} lang={language} formData={formData} />
//     </div>
//   </div>
// )}
